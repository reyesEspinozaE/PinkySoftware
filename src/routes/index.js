...
// import { isAuthenticated, isAdmin, isGuest } from '../middleware/authMiddleware.js';
...
// router.get('/index', isAuthenticated, isGuest, (req, res) => res.render('index', { title: "Pinky Piensa Web" }));
